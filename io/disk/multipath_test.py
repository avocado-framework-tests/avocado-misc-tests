...
class MultipathTest(Test):
    ...
    def test(self):
        ...
        self.test_fail_paths()

    def test_fail_paths(self):
        '''
        calling all function from here
        '''
        self.test_fail_reinstate_individual_paths()
        self.test_io_run_on_single_path()
        self.test_failing_reinstate_all_paths()
        self.test_removing_all_paths()
        self.test_suspend_resume_individual_mpath()
        self.test_suspend_resume_all_mpath()
        self.remove_add_mpath()

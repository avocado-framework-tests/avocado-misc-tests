...
class SoftwareRaid(Test):
    ...
    def _check_disks_healthy(self, disks, context=''):
        """
        Verify each disk in *disks* is accessible and shows no I/O errors.
        Uses 'lsblk' to confirm the device is present and readable.
        Fails the test if any disk is not healthy.

...
class ltp(Test):
    ...
    def setUp(self):
        ...
        if process.system(create_fs, shell=True, ignore_status=True) != 0:
        ...
        if process.system(mounting, shell=True, ignore_status=True) != 0:
...
#                self.fail("Unable to mount to location %s" % self.mount_point)
    ...
    def tearDown(self):
        ...
        if process.system(delete_fs, shell=True, ignore_status=True) != 0:
        ...
        if process.system(unmounting, shell=True, ignore_status=True) != 0:

...
fc-            if the module is of FC adapter then this value should be true which is used for flushing the multipath service without which we cannot unload the module. Flase if not FC adapter.:wq

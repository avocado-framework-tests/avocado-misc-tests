...
class Bonding(Test):
    ...
    def setUp(self):
        ...
        self.perr_if1 = process.system_output(cmd, shell=True).strip()
        if self.perr_if1 == "":
    ...
    def bond_remove(self, arg1):
        ...
        if arg1 == "local":
            ...
            cmd = "echo 'Bonding configuration removed on Peer machine';\
                  ...
                  sleep 5;"\
                  % (self.bond_name, self.perr_if1, self.peer_if2,
                     self.perr_if1, self.peer_if2, self.perr_if1,
                     self.bond_name, self.peer_if2, self.bond_name,
                     self.bond_name, self.peer_if2, self.perr_if1,
                     self.peer_ip)
        ...
        if arg1 == "local":
            ...
            cmd = "ip addr flush dev %s;\
                  ...
                  " % (self.perr_if1, self.peer_if2, self.perr_if1,
                       ...
                       self.bond_name, self.perr_if1, self.bond_name,
                       self.peer_if2, self.bond_name, self.perr_if1,

...
class ObservabilityTests(Test):
    ...
    def setUp(self):
        ...
        self.aiu_pcie_ids = self.params.get("AIU_PCIE_IDS", default=None)
        ...
        if self.aiu_pcie_ids:
            self.aiu_pcie_ids = self.aiu_pcie_ids.split()
        else:
    ...
    def tearDown(self):
        ...
        self.stop_inference_event = None

...
class GCC(Test):
    ...
    def setUp(self):
        ...
        if dist.name == 'Ubuntu':
            ...
            packages.extend(['glibc-static', 'autogen', 'guile',
                             ...
                             'gettext', 'sharutils', 'libgcj', 'libunwind'
                             'libgcc', 'libgomp'])
        ...
        tarball = self.fetch_asset(
            ...
            get_system_gcc_version, expire='7d')
        archive.extract(tarball, self.srcdir)
        gcc_folder = 'gcc-%s' % os.path.basename(tarball.split('.zip')[0])
    ...
    def test(self):
        ...
        """
        ret = build.run_make(self.srcdir, extra_args='check')

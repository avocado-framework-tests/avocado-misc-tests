...
class Systemtap(Test):
    ...
    def setUp(self):
        ...
        build.make(self.wordir, extra_args='install')
        self.test_dir = os.path.join(self.wordir, "testsuite")
    ...
    def test(self):
        ...
        build.make(self.wordir, extra_args=make_option)
        # path of the log file. self.wordir/testsuite/systemtap.sum

...
class kselftest(Test):
    ...
    def ksmtest(self):
        ...
        Ex: -M (page merging)
        """
        ksm_test_dir = os.path.join(self.sourcedir, "mm")
        ksm_test_bin = os.path.join(ksm_test_dir, "ksm_tests")
            ...
            if failures:
                ...
                if pmd_src_only_aligned:
                    ...
                    if min_both_pmd > 0:
                        ...
                        self.log.warning("Cannot calculate performance improvement: min_both_pmd is zero")
                self.log.info("=" * 80)
        else:
